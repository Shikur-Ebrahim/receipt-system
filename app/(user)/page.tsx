            ...
            >
              ...
              <div className="bg-[#f9f9f9] px-5 py-6">
                ...
                <div className="flex justify-center mt-0 mb-6">
                  <button
                    className="bg-[#cc9b52] text-black font-[700] text-[15px] tracking-[0.5px] rounded-full px-8 py-3.5 border border-black/15 shadow-none drop-shadow-none flex items-center gap-2.5"
